...
@Service
public class TurnaroundRawConsumer {

    private static final Logger logger = LoggerFactory.getLogger(TurnaroundRawConsumer.class);
    ...
    public TurnaroundRawConsumer(TurnaroundEventRepository repository, ObjectMapper objectMapper,
